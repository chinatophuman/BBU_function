...
class SFP_test:
    ...
    def test_content(self):
        ...
        if (not('Speed: 10000Mb/s' in SFPPORT1_info) or not('Link detected: yes' in SFPPORT1_info)):
        ...
        elif (not('Speed: 10000Mb/s' in SFPPORT2_info) or not('Link detected: yes' in SFPPORT2_info)):
        ...
        elif (not('Speed: 10000Mb/s' in SFPPORT3_info) or not('Link detected: yes' in SFPPORT3_info)):
        ...
        elif (not('Speed: 10000Mb/s' in SFPPORT4_info) or not('Link detected: yes' in SFPPORT4_info)):
            ...
            while (cnt<6):
                ...
                if (not('0% packet loss' in under_ping_info) or
                        ('10% packet loss' in under_ping_info) or ('100% packet loss' in under_ping_info)):
                    fail_cnt+=1
                    cnt+=1
                elif(not('0% packet loss' in under_ping_info) or
                        ('10% packet loss' in under_ping_info) or ('100% packet loss' in under_ping_info)):
                    fail_cnt+=1
                    cnt+=1
                else:
